...
\gcoql and the results presented in this paper have been developed in \coq v.8.9.1 and are provided as anonymous supplementary material. We often refer directly to \coq files in the paper. \gcoql extensively uses the libraries
