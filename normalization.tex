...
\begin{figure*}[t]
    ...
    \end{cases}
    \end{align*}
    \caption{Simplified semantics for queries in normal form.} \td{I use $\ll \cdot \gg$ in Coq, as well as HP, not this parenthesis}\td{Redoing it to match these parens}%\et{rename does\_fragment\_type\_apply to fragment\_type\_applies (and make it hide the $=$ true.)}}
