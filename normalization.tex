...
\small
    ...
    \end{cases}
    \end{align*}
    \caption{Normalization procedure for \gql selections. \et{what's going on here? there's normalize, and interpretation?}}
\label{fig:normalize}
\end{figure*}
...
\begin{figure*}[t]
    ...
    \end{cases}
    \end{align*}
    \caption{Simplified semantics for selections in normal form, adapted from~\cite{gqlph}. \et{why is it $\in L$ and not $= L$?}}
