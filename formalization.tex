...
\begin{figure*}[h]
  ...
  Symbol $\alpha$ stands for a list of key-value pairs, representing the arguments of fields.}
...
\small
    ...
    Finally, $\mathit{is\_valid\_response}$ validates the coerced value, $\mathit{ftype}$ retrieves the field's type in the given type in the schema, and $L$ represents the list type.}}
