...
then a node property matching the field must have a value that
represents a double-precision fractional value\footnote{The \spec
...
In order not to clutter the notation, we omit the underlying schama
