...
\texttt{Fiction} type, while in the second it is requesting information
about the \texttt{Animation} type. The distinction is important because some
...
the first occurrence refers to field \texttt{title} of a \texttt{Movie}, while the second
