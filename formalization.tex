...
% we omit the f
Full definition can be found in our
...
in the schema and that its properties are correct. In turn, a property is \emph{correct} if 
...
of arguments, we omit it and simple write the field name.
...
schema. % The coercion function is included as a parameter in the
