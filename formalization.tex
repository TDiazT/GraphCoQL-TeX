...
We model this with the function \et{use "mathit" to write words in math mode, eg. $\mathit{Vals}$ and not $Vals$ (notice the weird spacing you get between characters otherwise)}  $coerce : Vals \to ResponseValue$\td{We build a wfCoercion by proving that the coerced value is not redundant -- this might need more explanation}.
