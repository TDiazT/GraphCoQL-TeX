...
To model value validation throughout our development, we parameterize the corresponding modules with a predicate $ \mathit{\vscalar} : \mathit{graphQLSchema} \to \mathit{Name} \to \mathit{Scalar} \to \mathit{Bool}$.
