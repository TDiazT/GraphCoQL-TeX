...
\begin{figure*}[t!]
  ...
  Symbol $\alpha$ stands for a key-value pair.} \fo{Cannot push this
  figure to the (top of) previous page, where referred.}} 
...
A selection can be a single field with arguments ($\fld$), a field
...
($\ifrag{t}{\sset}$). Fields can be renamed or aliased ($\afld$). For
