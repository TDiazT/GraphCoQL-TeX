...
The GraphQL schema is pretty straightforward to define from the grammar of the \spec{}. It consists of a collection of type definitions and a root query operation type. 
\begin{minted}{coq}
...
\begin{figure*}
  ...
  \begin{subfigure}{.5\textwidth}
    ...
    \end{minted}
  \end{subfigure}
  \caption{Definition of GraphQL queries, the \spec{}'s grammar (left) and Coq implementation (right).}
  \label{fig:query_def}
\end{figure*}
