...
Finally, we define the schema's query type with the object type \texttt{Query}. 
This type is the same as regular object types, however it is special in the sense 
that it represents the entry point from where users have to 
